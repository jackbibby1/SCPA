...
## Plotting the output
Now we have all the results, we can plot a summary of the data to get an idea of any broad patterns.
...
And create rown annotations for the heatmap to highlight these pathways
```{r, eval=F}
