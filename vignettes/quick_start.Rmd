...
### Loading in data
Here we're going to use a subset of data taken from the [Szabo, P... Sims, P](https://www.nature.com/articles/s41467-019-12464-3) paper. You can find this data in an R object [here](https://drive.google.com/file/d/1-HJHfSMw5EBP02ZjTrbX7Pd_5eYGe1Zz/view?usp=sharing)

```{r load_data, echo=F, eval=F}
load("~/Google Drive/example_datasets/")
...
```{r, echo=F}
scpa_out <- readRDS("/Volumes/GoogleDrive/My Drive/r_packages/SCPA/rds_files/tcm_th1.rds")
```
...
You can use SCPA to generate a pathway rank plot. For example, we can highlight the topmost MTORC1 pathway using the `plot_rank` function.
