...
![](../man/figures/fine_tissue.png){width=50%}
...
tcm <- seurat_extract(t_cells,
                      meta1 = "fine", value_meta1 = "cd4_tcm")
th1 <- seurat_extract(t_cells,
                      meta1 = "fine", value_meta1 = "cd4_th1")
```
...
```{r, echo=F}
scpa_out <- readRDS("/Volumes/GoogleDrive/My Drive/r_packages/SCPA/rds_files/th1_tcm.rds")
```
