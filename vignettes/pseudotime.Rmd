...
And then these steps are broadly taken from the [dyno vignettes](https://dynverse.org/users/3-user-guide/). We're just taking expression
...
![](../man/figures/aa_metab_rank.png){width=70%}
