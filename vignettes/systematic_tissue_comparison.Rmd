...
And load in the dataset. To see how we processed and integrated the datasets to generate this file, you can see the script [here](https://github.com/jackbibby1/scpa_paper/blob/main/figure_5.R).
