...
```{r, echo=FALSE}
scpa_out <- readRDS("../rds_files/th1_tcm.rds")
```
...
we know that these distribution changes identified by SCPA are still important for cellular behaviour. We show an example of this in Figure 4 
...
propose using something like a ranking plot to visualize the distribution of qvals, whilst still being able to highlight certain pathways. We provide
